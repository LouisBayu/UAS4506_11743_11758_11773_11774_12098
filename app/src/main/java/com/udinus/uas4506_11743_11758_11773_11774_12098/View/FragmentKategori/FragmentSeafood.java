...
public class FragmentSeafood extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_seafood, container, false);
        initComponent(view);
        setRecyclerView();
        getResepFromFirebase("Seafood");
        return view;
    }

    private void initComponent(View view){
        context = getActivity();
        recyclerView = (RecyclerView)view.findViewById(R.id.viewSeafood);
