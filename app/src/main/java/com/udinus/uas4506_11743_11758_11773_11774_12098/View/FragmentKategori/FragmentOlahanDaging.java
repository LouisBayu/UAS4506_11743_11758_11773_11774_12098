...
public class FragmentOlahanDaging extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_olahan_daging, container, false);
        initComponent(view);
        setRecyclerView();
        getResepFromFirebase("Olahan Daging");
        return view;
    }

    private void initComponent(View view){
        context = getActivity();
        recyclerView = (RecyclerView)view.findViewById(R.id.viewOlahanDaging);
